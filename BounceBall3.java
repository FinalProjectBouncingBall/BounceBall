...
public class BounceBall3 extends JFrame {

    public static void main(String[] args) {
        new BounceBall3();

//        System.out.println( BallGLEventListener.matrix[8][0]);
//        System.out.println( BallGLEventListener.matrix[9][0]);
    }
    public BounceBall3() {
        GLCanvas glcanvas;
        Animator animator;
...
class BallGLEventListener extends MenuListener{
        ...
        String textureNames[] = {"BouncingBall2.jpg","flcustom.png","PngItem_5608811.png",
                "HeartTry.jpg","intersection2.jpg","Levels.jpg"};
...
//         xDirection = -5 *speed;
            if(changeState==false){
                DrawBackground(gl);
                if(xPosition>35&&xPosition<65 && yPosition>10&&yPosition<30){
//        changeState=true;
                ...
                if(xPosition>=36&&xPosition<=50&&yPosition>=80&&yPosition<=90){
                    changeState=true;
                    speed=1;
                }
                if(xPosition>=27&&xPosition<=70&&yPosition>=55&&yPosition<=66){
                    changeState=true;
                    speed=1.3;
                }
                if(xPosition>=33&&xPosition<=65&&yPosition>=32&&yPosition<=44){
                    changeState=true;
                    speed=1.5;
                }
            }
            ...
            if(xPosition>4&&xPosition<15&&yPosition>90&&yPosition<99){
                gl.glEnable(GL.GL_BLEND);
                gl.glClear(GL.GL_COLOR_BUFFER_BIT);
